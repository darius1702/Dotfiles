...
(custom-set-variables
 ...
 '(package-selected-packages
   '(interactive-haskell-mode haskell-mode git-gutter evil-collection undo-tree evil helpful gruber-darker-theme ivy-rich swiper diminish markdown-mode which-key rainbow-delimiters raninbow-delimiters doom-themes exec-path-from-shell latex-preview-pane magit use-package ivy))
 '(show-paren-mode t))
